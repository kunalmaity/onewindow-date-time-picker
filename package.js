...
Package.onTest(function(api) {
  api.use('ecmascript');
  api.use('tinytest');
  api.use('kunalmaity:onewindow-date-time-picker');
  api.addFiles('bootstrap-ui-datetime-picker-onewindow-tests.js');
});
