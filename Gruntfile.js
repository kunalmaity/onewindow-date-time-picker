...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      jsTest: {
        files: ['<%= yeoman.client %>/{app,components,specs}/**/*.{spec,mock}.js'],
    ...
    jshint: {
      ...
      test: {
        src: ['<%= yeoman.client %>/{app,components,specs}/**/*.{spec,mock}.js']
      }
    },
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,specs}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
